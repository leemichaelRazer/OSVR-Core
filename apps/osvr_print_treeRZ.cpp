...
int print_tree_main(void) {
	...
	opts.showAliasSource = true;
	opts.showAliasPriority = true;
	opts.showDeviceDetails = true;
	opts.showDeviceDescriptor = true;
	opts.showSensors = true;
	opts.showStringData = true;
